<template>
    <div class="space-y-4">
        ...
        <div class="w-full relative">
            ...
            <div class="h-full absolute top-0 right-0 w-8 bg-gradient-to-l from-grayLightPrimary to-transparent pointer-events-none"></div>
            <div class="h-full absolute top-0 left-0 w-8 bg-gradient-to-r from-grayLightPrimary to-transparent pointer-events-none"></div>
        </div>
    </div>
</template>
