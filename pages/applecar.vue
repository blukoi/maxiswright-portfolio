    ...
    <div>
        ...
        <IntroTitle :bgColor="bgColor" mediaBackground="bg-grayDarkest">
            ...
            <template #media>
                <VideoCover
                :videoSources="[
                    { src: '/Work/EV/0_Video_1080.mp4', type: 'video/mp4' },
                    { src: '/Work/EV/0_Video_720.mp4', type: 'video/mp4' },
                    { src: '/Work/EV/0_Video_480.mp4', type: 'video/mp4' },
                    ]">
                </VideoCover>
            </template>
            <template #info>
                <PillsAlone 
                    :items="['Automotive UX', 'Role: UX Researcher, Product Designer', '9 Weeks', 'October - December 2023', '5 Team Members']">
                </PillsAlone>
            </template>
            <template #tools>
                <PillsAlone 
        ...
        >
            <template #caption>
                <p class="font-main text-sm">As cars and technology evolve, integrating personal devices and experiences into the driving environment often feels clunky, especially as the divide between car manufacturers and technology companies continues to grow.</p>
            </template>
            <template #media>
                <ImagePrimary
                    srcset-small="/Work/EV/0_Problem_Med.jpeg"
                    srcset-medium="/Work/EV/0_Problem_Med.jpeg"
        ...
        >
            ...
            >
                <template #caption>
                    <p>One of Apple’s crowning achievements is the product ecosystem they’ve created. <span class="font-bold">The seamless integration of all their devices and the ease with which users can navigate between them is unmatched.</span> The Apple ecosystem scratches that, almost primal, desire for things to just work.</p>
                </template>
                <template #media>
                    <ImagePrimary
            ...
            >
                ...
                <ScrollerImage
                    ...
                    sizes="(max-width: 768px) 100vw, (max-width: 1200px) 50vw, 1200px"
                    title="Current (2023) iOS Visual Design"
            ...
            >
                <template #caption>
                    <p class="mb-4">Apple wants the VR space to be it’s own 'tangible' space that can augment and empower both real-world and digital interactions. They’ve evolved their design system (shown above) to work better in 3-dimensional spaces and have also researched how to utilize the series of outward-facing cameras for better perception and recognition of tiny hand gestures and motions.</p>
                    <ContentTakeaway
                        title="Takeaway"
                        highlightColor="#89CBFB"
                    >
                        <template #copy>
                            <p>Apple is actively trying to make practical use of mixed reality technologies.</p>
                        </template>
                    </ContentTakeaway>
                </template>
                <template #media>
            ...
            >
                ...
                <template #postits>
                    ...
                    >
                        <template #copy>
                            <p>"Continuous" OS/experience between devices when getting into your car.</p>
                        </template>
                    </ContentPostit>
                    <ContentPostit
                        postitColor="bg-postitYellow"
                    >
                        <template #copy>
                            <p>Apple Wallet can have a "car profile" to remember preferences when moving between cars.</p>
                        </template>
                    </ContentPostit>
                    <ContentPostit
                        postitColor="bg-postitYellow"
                    >
                        <template #copy>
                            <p>Color highlights for autonomous features, with ambient lights to highlight when in use.</p>
                        </template>
                    </ContentPostit>
                    <ContentPostit
                        postitColor="bg-postitYellow"
                    >
                        <template #copy>
                            <p>Mixed reality integration for in-car working space, like with Apple Vision.</p>
                        </template>
                    </ContentPostit>
                    <ContentPostit
                        postitColor="bg-postitYellow"
                    >
                        <template #copy>
                            <p>Reinforce your car as a personal, third space with features like using your trunk for deliveries.</p>
                        </template>
                    </ContentPostit>
                </template>
            </ContentCaptionWithPostits>
        ...
        >
            ...
            >
                <template #caption>
                    <p>One of the major things that people are averse to is seeing “Settings” pages when talking about a new feature or concept. With that in mind, I made a quick proof of concept just to show what a user might actually encounter during the actual event.</p>
                </template>
            </ContentImagesWithCaption>
        ...
        >
            ...
            >
                ...
                <template #caption>
                    <p>This is a mockup from Apple showing their vision for cars powered by CarPlay, where CarPlay is envisioned as the controller for all onboard, digital systems. Since our concept involves AR technology, we wanted to take our design system further in that direction than this existing iOS-based visual design.</p>
                </template>
            </ContentFeatureWithCaption> -->
